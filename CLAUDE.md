...
- **Route tree is auto-generated**: `routeTree.gen.ts` files are regenerated by the dev server. Never manually edit or regenerate them. Ignore any errors related to stale route trees.
