...
import { toggleVariants } from "@laxdb/ui/components/ui/toggle";
...
function ToggleGroupItem({
  ...
  return (
    <TogglePrimitive
      ...
      data-size={Number(context.size) > 0 || size}
      ...
      className={cn(
        ...
        toggleVariants({
          ...
          // oxlint-disable-next-line explicit-length-check - not a number??
