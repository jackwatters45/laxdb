export function RunIcon({ size = 16 }) {
  return (
    <svg
    ...
    >
      ...
      />
      <path
        d="M12.6129 8.26709L9.30469 12.4023L13.4399 16.5376L11.3723 21.0863"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M6.41016 9.50741L9.79704 6.19922L12.613 8.26683L15.5078 11.5751H19.2295"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M8.89055 15.7104L7.64998 16.5375H4.3418"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function WalkIcon({ size = 16 }) {
  return (
    <svg
...
export function YogaIcon({ size = 16 }) {
  return (
    <svg
      aria-label="Yoga icon"
      width={size}
      height={size}
      strokeWidth="1.5"
      viewBox="0 0 24 24"
...
export function RestIcon({ size = 16 }) {
  return (
    <svg
...
export function RideIcon({ size = 16 }) {
  return (
    <svg
      width={size}
      height={size}
