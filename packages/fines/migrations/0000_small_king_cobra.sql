...
CREATE TABLE `fines` (
	...
	FOREIGN KEY (`template_id`) REFERENCES `fine_templates`(`id`) ON UPDATE no action ON DELETE set null,
...
CREATE TABLE `fine_events` (
	...
	FOREIGN KEY (`fine_id`) REFERENCES `fines`(`id`) ON UPDATE no action ON DELETE cascade,
...
--> statement-breakpoint
CREATE INDEX `fine_templates_org_idx` ON `fine_templates` (`organization_id`);