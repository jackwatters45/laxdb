...
export const Route = createFileRoute("/blog/wiki")({
  component: BlogWiki,
});

function BlogWiki() {
  // Blog + wiki, but NOT opinion (crossover articles)
  const wikiPosts = getContentByTags(allPosts, ["blog", "wiki"], ["opinion"]);
  const sortedPosts = [...wikiPosts].toSorted(
