    ...
    <main className="mx-auto max-w-screen-sm px-4 py-16 md:py-32">
      <header className="mb-8">
        ...
        <nav className="mt-4 flex gap-4 text-sm">
          <Link to="/blog/opinion" className="text-muted transition-colors hover:text-foreground">
            Opinion
          </Link>
          <Link to="/blog/wiki" className="text-muted transition-colors hover:text-foreground">
            Wiki Crossover
          </Link>
        </nav>
      </header>
