...
import { Card } from "@laxdb/ui/components/ui/card";
...
export const Route = createFileRoute("/_protected/$organizationSlug/settings/general/")({
  component: General,
});
        ...
        <div className="container space-y-10 py-8">
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-6">
                    ...
                    <div className="col-span-full sm:col-span-3">
                      ...
                      <Select defaultValue="member">
                        <SelectTrigger className="mt-2" disabled id="role" name="role">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                          {roles.map((role) => (
                ...
                <div className="md:col-span-2">
                  <fieldset>
                    ...
                    <ul className="mt-4 divide-y divide-border">
                      <li className="flex items-center gap-x-3 py-3">
                        <Checkbox defaultChecked id="team-requests" name="team-requests" />
                  ...
                  <fieldset className="mt-6">
                    ...
                    <ul className="mt-4 divide-y divide-border">
                      ...
                      <li className="flex items-center gap-x-3 py-3">
                        <Checkbox defaultChecked id="query-caching" name="query-caching" />
          ...
          <section aria-labelledby="danger-zone">
            <form>
              <div className="grid grid-cols-1 gap-x-14 gap-y-8 md:grid-cols-3">
                <div>
                  <h2 className="scroll-mt-10 font-semibold text-foreground" id="danger-zone">
                    Danger zone
                  </h2>
                  <p className="mt-1 text-sm leading-6 text-muted-foreground">
                    ...
                    <div className="flex items-start justify-between gap-10">
                      <div>
                        ...
                        <p className="mt-2 text-sm leading-6 text-muted-foreground">
                          Revoke your access to this team. Other people you have added to the
                          workspace will remain.
                        </p>
                      </div>
                      <Button className="text-red-600 dark:text-red-500" variant="secondary">
                        Leave
                      </Button>
                    </div>
                  </Card>
