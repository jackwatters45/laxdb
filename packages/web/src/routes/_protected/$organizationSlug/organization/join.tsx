...
export const Route = createFileRoute("/_protected/$organizationSlug/organization/join")({
    ...
    <DashboardHeader>
      <BreadcrumbItem>
        <BreadcrumbLink
          ...
          render={<Link params={{ organizationSlug }} to="/$organizationSlug/organization/join" />}
        >
          Join Organization
        </BreadcrumbLink>
      </BreadcrumbItem>
